            ...
            {visible.map((entry) => {
              ...
              return (
                <div
                  key={entry.id}
                  className={cn(
                    "border border-slate-200 dark:border-slate-700 rounded-lg p-3 hover:border-[#89bcbe]/50 transition-colors",
          ...
          <>
            {visible.map((desp) => {
              ...
              return (
                <div
                  key={desp.id}
                  className="border border-slate-200 dark:border-slate-700 rounded-lg p-3 hover:border-[#89bcbe]/50 transition-colors group"
                >
                  <div className="flex items-start justify-between mb-2">
