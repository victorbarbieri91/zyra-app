...
export default function PecasTesesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 dark:from-surface-0 via-white dark:via-surface-0 to-slate-50/50 dark:to-surface-0 p-4 md:p-6">
      <div className="max-w-[1800px] mx-auto space-y-4 md:space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-xl md:text-2xl font-bold text-[#34495e] dark:text-slate-200">Peças e Teses</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        ...
        <Link href="/dashboard/pecas-teses/templates">
          <Card className="border-slate-200 dark:border-slate-700 hover:shadow-lg hover:border-[#34495e]/30 transition-all cursor-pointer group h-full">
            <CardContent className="pt-8 pb-6">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div>
                  <h2 className="text-lg font-bold text-[#34495e] dark:text-slate-200 mb-1">
                    Templates
                  </h2>
                ...
                <div className="flex items-center gap-2 text-sm text-[#34495e] dark:text-slate-200 font-medium pt-2">
                  <span>Acessar</span>
        ...
        <Link href="/dashboard/pecas-teses/banco">
          <Card className="border-slate-200 dark:border-slate-700 hover:shadow-lg hover:border-[#89bcbe]/30 transition-all cursor-pointer group h-full">
            <CardContent className="pt-8 pb-6">
              <div className="flex flex-col items-center text-center space-y-4">
            ...
            <CardContent className="pt-8 pb-6">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div>
                  ...
                  <div className="inline-block px-3 py-1 bg-blue-100 dark:bg-blue-500/10 rounded-full">
      ...
      {/* Info Card */}
      <Card className="border-slate-200 dark:border-slate-700 bg-gradient-to-r from-slate-50 dark:from-surface-0 to-slate-100/50 dark:to-surface-2/50">
