    ...
    <div className="space-y-4 md:space-y-6 p-4 md:p-6">
      ...
      <ModalRecebimento
        ...
        item={faturaParaReceber ? {
          ...
          valor_bruto: Number(faturaParaReceber.valor_total),
          valor_liquido: Number(faturaParaReceber.valor_liquido ?? faturaParaReceber.valor_total),
          total_retencoes: Number(faturaParaReceber.total_retencoes ?? 0),
