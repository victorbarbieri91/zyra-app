    ...
    >
      <CardHeader className="pb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <CardTitle className="text-base text-[#34495e] dark:text-slate-200">
              Tarefas do Dia
            </CardTitle>
      ...
      <CardContent className="pt-0">
        {tarefas.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-[#6c757d] dark:text-slate-400 mb-1">
          ...
          <ScrollArea className="h-[calc(100vh-320px)]">
            <div className="space-y-2.5 pr-3">
              <p className="text-xs font-medium text-[#46627f] dark:text-slate-400 mb-2">
        ...
        {isOver && tarefas.length > 0 && (
          <div className="absolute inset-0 bg-[#89bcbe]/5 border-2 border-dashed border-[#89bcbe] rounded-lg flex items-center justify-center pointer-events-none">
            <div className="bg-white dark:bg-surface-1 px-4 py-2 rounded-md shadow-lg">
